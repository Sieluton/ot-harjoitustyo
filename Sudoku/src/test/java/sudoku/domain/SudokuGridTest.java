...
public class SudokuGridTest {
    ...
    @Test
    public void equalWhenConstructorGivenValidInput(){
        int[][] grid1 = new SudokuGrid("295743861431865927876192543389459216612387495549216738763534189928671354154938672").getGrid();
        int[][] grid2 = new int[][]{
                {2,9,5,7,4,3,8,6,1},
                {4,3,1,8,6,5,9,2,7},
                {8,7,6,1,9,2,5,4,3},
